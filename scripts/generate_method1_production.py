...
def main():
    ...
    try:
        _run_cells(args, player_ids, wrappers, base, representative_elos, metadata, guardrail, engine_pool)
    finally:
...
def _run_cells(args, player_ids, wrappers, base, representative_elos, metadata, guardrail, engine_pool):
    only_dyad = (
